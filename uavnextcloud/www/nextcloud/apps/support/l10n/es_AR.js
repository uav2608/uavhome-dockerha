OC.L10N.register(
    ...
    "A Nextcloud Support Subscription means the original developers behind your private cloud server are 100% dedicated to your success: the security, scalability, performance and functionality of your service!" : "Una Suscripción de Soporte de Nextcloud significa que los desarrolladores originales detrás de su servidor de nube privada están 100% dedicados a su éxito: la seguridad, escalabilidad, rendimiento y funcionalidad de su servicio.",
    "If you encounter a problem and your server does no longer work, blocking employees from sharing or customers from downloading and uploading files, you don't have to rely on searching online and asking volunteers on forums and social media for a solution. You have direct access to our experienced engineers who help you track down and fix the problem." : "Si se encuentra con un problema y su servidor ya no funciona, lo que impide que los empleados compartan o que los clientes descarguen y carguen archivos, no tiene que depender de la búsqueda en línea y de solicitar una solución a los voluntarios en foros y redes sociales. Usted tiene acceso directo a nuestros ingenieros experimentados que lo ayudan a rastrear y solucionar el problema.",
    "You have a contract with the vendor providing confidential security information, mitigations, patches and updates." : "Tiene un contrato con el proveedor que proporciona información confidencial de seguridad, mitigaciones, parches y actualizaciones.",
    "If you want to skip a release or two and stay a bit longer on your current version without disruptions, you don't have to run software without security updates. We deliver them to you as long as is needed!" : "Si desea omitir una versión o dos y quedarse un poco más en su versión actual sin interrupciones, no tiene que ejecutar software sin actualizaciones de seguridad. ¡Se los entregamos siempre que sea necesario!",
    "If you have performance and scalability issues you have the best expertise at hand, instead of having to search on the web and hope you find a solution." : "Si tiene problemas de rendimiento y escalabilidad, tiene a mano la mejor experiencia, en lugar de tener que buscar en la web y esperar que encuentre una solución.",
    "If you are asked how the compliance of Nextcloud is and if you can deliver a data export under GDPR, HIPAA or other rules, you have access to the right documentation and can tap into our expertise to respond quickly and accurately." : "Si se le pregunta cuál es el cumplimiento de Nextcloud y si puede realizar una exportación de datos según GDPR, HIPAA u otras reglas, tiene acceso a la documentación correcta y puede aprovechar nuestra experiencia para responder de manera rápida y precisa.",
    "We can also provide you Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a very limited form for free. And we can develop further integrations and capabilities you need." : "También podemos proporcionarle integración con Outlook, Office en línea, comunicación de audio y video integrada y chat escalable, y otras funciones sólo disponibles de forma muy limitada y gratuita. Y podemos desarrollar otras integraciones y capacidades que necesite.",
    "A subscription helps you get the most out of Nextcloud! Don't your users deserve the best?" : "¡Una suscripción te ayuda a sacar el máximo provecho de Nextcloud! ¿Sus usuarios no merecen lo mejor?",
    ...
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact you Nextcloud account manager to get your subscription updated!" : "Su suscripción a Nextcloud no cubre la cantidad de usuarios que actualmente están activos en este servidor. Póngase en contacto con su administrador de cuenta de Nextcloud para que se actualice su suscripción.",
    "Thank you," : "Gracias,",
    ...
    "Your Nextcloud server Subscription is expired!" : "Su suscripción al servidor Nextcloud ha caducado!",
    "Your Nextcloud Subscription has expired! Please contact you Nextcloud account manager to get your subscription updated!" : "Tu suscripción a Nextcloud ha expirado! Póngase en contacto con su administrador de cuenta de Nextcloud para que se actualice su suscripción.",
    "Support" : "Soporte",
    ...
    "Pricing" : "Precios",
    "Commmunity support" : "Apoyo comunitario",
    "Forum" : "Foro",
    "GitHub" : "GitHub",
    "Chat" : "Chat",
